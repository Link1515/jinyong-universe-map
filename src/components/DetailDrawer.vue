...
<template>
  <Transition name="status-panel" mode="out-in">
    <aside v-if="detailOpen" key="expanded" class="overlay-panel overlay-panel-detail">
      <button type="button" class="panel detail-handle" aria-expanded="true" aria-label="收起詳細資訊" @click="emit('toggleOpen')">
        <Icon icon="lucide:panel-right-close" class="detail-handle-icon" />
      </button>
    ...
    <aside v-else key="collapsed" class="overlay-panel overlay-panel-detail detail-panel-collapsed">
      <button type="button" class="panel detail-handle" aria-expanded="false" aria-label="展開詳細資訊" @click="emit('toggleOpen')">
        <Icon icon="lucide:panel-right-open" class="detail-handle-icon" />
      </button>
    </aside>
  </Transition>
</template>
