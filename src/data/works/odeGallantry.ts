...
export const characters: Character[] = [
  {
    ...
    name: '石破天',
    aliases: ['狗雜種'],
    novels: ['ode-gallantry'],
    gender: 'male',
    factions: ['長樂幫', '俠客島'],
    title: '俠客島傳人',
    description: '憨厚善良，因身分錯置誤入重重江湖陰謀。',
    tags: ['主角'],
  },
  {
    id: 'ding-dang',
...
export const relationships: Relationship[] = [
  ...
  { id: 'r42', source: 'shi-potian', target: 'shi-zhongyu', type: 'rival', label: '身份鏡像', description: '兩人相貌相似造成重重衝突與誤認。', directed: false, novels: ['ode-gallantry'], weight: 4 },
  {
    ...
    type: 'rival',
    label: '江湖衝突',
    description: '白萬劍與石破天在俠客島事件中多次交鋒。',
    directed: false,
    novels: ['ode-gallantry'],
    weight: 3,
  },
