...
export const relationships: Relationship[] = [
  ...
  },
  {
    id: 'r23',
    source: 'yuan-guannan',
    target: 'zhuo-tianxiong',
    type: 'rival',
    label: '奪刀對立',
    description: '袁冠南與卓天雄為寶刀秘密多次對峙。',
    directed: false,
    novels: ['mandarin-ducks-blades'],
    weight: 4,
  },
